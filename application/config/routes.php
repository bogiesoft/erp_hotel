...
// residents
$route['residents/resident-list'] = 'hotel_management/front_office/residents';
$route['add-resident'] = 'hotel_management/front_office/add_resident';

$route['resident-details/(:num)'] = 'hotel_management/front_office/resident_details/$1';
$route['resident-details/(:num)/(:num)/(:num)/(:num)'] = 'hotel_management/front_office/resident_details2/$1/$2/$3/$4';
$route['register-payment/(:num)/(:num)/(:num)/(:num)'] = 'hotel_management/front_office/register_payment/$1/$2/$3/$4';
$route['register-resident-bill/(:num)/(:num)/(:num)'] = 'hotel_management/front_office/register_resident_bill/$1/$2/$3';
$route['update-resident-room-details/(:num)/(:num)'] = 'hotel_management/front_office/update_resident_room_details/$1/$2';
$route['register-resident-receipt/(:num)/(:num)/(:num)'] = 'hotel_management/front_office/register_resident_receipt/$1/$2/$3';


// buildings
$route['residents/building'] = 'hotel_management/front_office/building_details';
$route['buildings'] = 'hotel_management/front_office/building_details';
$route['add-building'] = 'hotel_management/front_office/add_building';
$route['building-details/(:num)'] = 'hotel_management/front_office/edit_building_details/$1';
$route['residents/floors'] = 'hotel_management/front_office/floors';



$route['rooms/room-type'] = 'hotel_management/front_office/room_type';
$route['room-types'] = 'hotel_management/front_office/room_type';
$route['add-room-type'] = 'hotel_management/front_office/add_room_type';



$route['rooms/room-charges'] = 'hotel_management/front_office/room_type_charge';
$route['add-room-type-charge'] = 'hotel_management/front_office/add_room_charges';

$route['room-charges'] = 'hotel_management/front_office/room_type_charge';
$route['rooms/rooms'] = 'hotel_management/front_office/room_details';
$route['rooms'] = 'hotel_management/front_office/room_details';
$route['add-room'] = 'hotel_management/front_office/add_room';
